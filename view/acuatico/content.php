...
<br><br>
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/acuatico/buceo.jpg" class="imagen" alt="" height="450px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Buceo</h3> <!--beatriz-->
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/acuatico/surfeo.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Surfeo</h3> <!--beatriz-->
                        <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/acuatico/natacion.jpg" alt="" class="mt-5" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Natación</h3> <!--beatriz-->
                        <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/acuatico/waterpolo.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Waterpolo</h3> <!--beatriz-->
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/acuatico/kayak.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Kayak</h3> <!--beatriz-->
                    </div>
                        ...
                        <div id="tab1" class="tab-pane active">
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <?php 
                                    ...
                                    FROM inventario_productos AS inv, categorias AS cat WHERE inv.cod_categ=cat.cod_categ AND nom_categ='Acuatico'
                                    ORDER BY cod_inv";
