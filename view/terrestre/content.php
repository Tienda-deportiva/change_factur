...
<br><br>
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/terrestre/karate.jpg" class="imagen" alt="" height="450px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Karate</h3> <!--beatriz-->
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/terrestre/tennis.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Tennis de Campo</h3> <!--beatriz-->
                        <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/terrestre/boxeo.jpg" alt="" class="mt-5" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Boxeo</h3> <!--beatriz-->
                        <br><br>
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/terrestre/ping.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Ping Pong</h3> <!--beatriz-->
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/terrestre/golf.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Golf</h3> <!--beatriz-->
                    </div>
                        ...
                        <div id="tab1" class="tab-pane active">
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <?php 
                                    ...
                                    FROM inventario_productos AS inv, categorias AS cat WHERE inv.cod_categ=cat.cod_categ AND nom_categ='Terrestre'
                                    ORDER BY cod_inv";
