...
<br><br>
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/aereo/aerostatico.jpg" class="imagen" alt="" height="450px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Globo Aerostático</h3> <!--beatriz-->
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/aereo/aeroplano.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Aeroplano</h3> <!--beatriz-->
                        <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/aereo/paracaidas.jpg" alt="" class="mt-5" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Paracaídismo</h3> <!--beatriz-->
                        <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/aereo/parapente.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Parapente</h3> <!--beatriz-->
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/aereo/rapel.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Rapel Volado</h3> <!--beatriz-->
                    </div>
                </div>
            </div>
            <!-- /shop -->
                        ...
                        <div id="tab1" class="tab-pane active">
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <?php 
                                    ...
                                    FROM inventario_productos AS inv, categorias AS cat WHERE inv.cod_categ=cat.cod_categ 
                                    AND nom_categ='Aereo' ORDER BY cod_inv";
