...
<br><br>
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/grupal/beisbol.jpg" class="imagen" alt="" height="450px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Béisbol</h3> <!--beatriz-->
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/grupal/futbol.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Fútbol</h3> <!--beatriz-->
                        <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/grupal/basket.jpg" alt="" class="mt-5" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Baloncesto</h3> <!--beatriz-->
                        <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/grupal/voleibol.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Voleibol</h3> <!--beatriz-->
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-8"> <!--beatriz-->
                <div class="shop">
                    <div class="shop-img">
                        <img src="./img/grupal/hockey.jpg" alt="" height="210px" width="350px"> <!--beatriz-->
                    </div>
                    <div class="shop-body">
                        <h3>Hockey</h3> <!--beatriz-->
                    </div>
                </div>
            </div>
            <!-- /shop -->
                        ...
                        <div id="tab1" class="tab-pane active">
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <?php 
                                    ...
                                    FROM inventario_productos AS inv, categorias AS cat WHERE inv.cod_categ=cat.cod_categ AND nom_categ='Grupal'
                                    ORDER BY cod_inv";
